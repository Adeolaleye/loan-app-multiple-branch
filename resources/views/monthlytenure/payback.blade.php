          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-5 col-lg-5 padding-0">
                    <span class="f-14 f-w-600">{{$branchName}} Client ID : {{ $loan->client->client_no }}</span>
                    <a href="{{ route('viewclient',['id' => $loan->client->id, 'branchID' => $branchID, 'viewType' => $viewType]) }}" data-bs-toggle="tooltip" title="View Client Details">
          ...
          <div class="card-body">
            @include('includes.alerts')
                ...
                <div class="row m-t-20 text-center">
                    ...
                    <div class="col-6 col-lg-3 text-center">
                        <p class="f-14 text-success" style="margin-bottom: 0rem">Interest</p>
                        <h3 class="f-14 f-w-600">
                            <span>
                                &#x20A6;{{ number_format($loan->interest)}}<br>
                                <span class="font-success f-12 f-w-300">{{$loan->interest_percent}}% per month</span>   
                            </span>
                        </h3>
                    </div>
                    <div class="col-6 col-lg-3 text-center">
                        <p class="f-14 text-warning" style="margin-bottom: 0rem">Amount Disbursed</p>
                        <h3 class="f-14 f-w-600"><span>&#x20A6;{{ number_format($loan->amount_disburse) }}</span></h3>
                    </div>
                    <div class="col-6 col-lg-3 text-center">
                    ...
                    <div class="col-6 col-lg-3 text-center">
                        <p class="f-14 text-success" style="margin-bottom: 0rem">Payback Per Day</p>
                        <h3 class="f-14 f-w-600">
                            <span>
                ...
                @if ($loan->client->status == 'tenure extended' || $loan->client->status == 'in tenure' )
                    ...
                    <div class="text-center">
                        ...
                        <form id="fullpay" class="f1" method="post" action="{{ route('monthlypaynow',$loan->id) }}">
                        @csrf
